const CACHE="galgenmaennchen-v1-3-layout3";
const ASSETS=["./","./index.html","./manifest.webmanifest","./icons/app-icon.png","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png"];
